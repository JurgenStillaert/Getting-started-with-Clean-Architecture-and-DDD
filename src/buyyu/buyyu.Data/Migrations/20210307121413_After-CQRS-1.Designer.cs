...
namespace buyyu.Data.Migrations
{
    ...
    [Migration("20210307121413_After-CQRS-1")]
    partial class AfterCQRS1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("buyyu.Domain.Shipment.ShipmentRoot", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("buyyu.Domain.Shipment.ShipmentRoot", b =>
                {
                    b.OwnsOne("buyyu.Domain.Shipment.ShipmentDate", "ShipmentDate", b1 =>
                        {
                            b1.Property<Guid>("ShipmentRootId")
                                .HasColumnType("uniqueidentifier");
                            ...
                            b1.HasKey("ShipmentRootId");

                            b1.ToTable("Shipments");

                            b1.WithOwner()
                                .HasForeignKey("ShipmentRootId");
                        });

                    b.Navigation("ShipmentDate");
                });
            ...
            modelBuilder.Entity("buyyu.Domain.Warehouse.WarehouseRoot", b =>
                {
                    b.OwnsOne("buyyu.Domain.Shared.Quantity", "QtyInStock", b1 =>
                        {
                            b1.Property<Guid>("WarehouseRootId")
                                .HasColumnType("uniqueidentifier");
                            ...
                            b1.HasKey("WarehouseRootId");

                            b1.ToTable("Warehouses");

                            b1.WithOwner()
                                .HasForeignKey("WarehouseRootId");

                            b1.HasData(
                                new
                                {
                                    WarehouseRootId = new Guid("de679c55-4c13-4fe7-91b4-69cbce3223a2"),
                                    Value = 213
                                },
                                new
                                {
                                    WarehouseRootId = new Guid("32f75bce-16a0-4070-9fac-4289678c191f"),
                                    Value = 75
                                },
                                new
                                {
                                    WarehouseRootId = new Guid("bcbc1851-6317-4022-be62-53d29c04bcda"),
                                    Value = 179
                                },
                                new
                                {
                                    WarehouseRootId = new Guid("5ca659b1-25b1-45c1-9755-3a3cd8591b9e"),
                                    Value = 150
                                });
                        });
